import {
  buildFollowDotScore,
  recordFollowDotSample,
} from "./follow-dot-score.js";
...
export function updateFollowDot(store) {
  ...
  store.assessment.result = {
    ...
    instruction:
      "Follow the dot with your eyes. Keep your head as still as possible.",
    score: buildFollowDotScore(),
  };
}
